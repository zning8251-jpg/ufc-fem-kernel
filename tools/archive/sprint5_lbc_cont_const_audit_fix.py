"""
Sprint 5: LoadBC + Contact + Constraint Audit & Fix
Covers these domains across L3_MD, L4_PH, L5_RT
"""
import os, re
...
DOMAIN_KEYWORDS = ['LoadBC', 'Load', 'Contact', 'Constraint', 'Interaction', 'Friction']
...
for layer in ['L3_MD', 'L4_PH', 'L5_RT']:
    ...
    for d in os.listdir(layer_dir):
        ...
        if os.path.isdir(full) and any(kw.lower() in d.lower() for kw in DOMAIN_KEYWORDS):
            DIRS.append(full)
...
print(f'\n=== Sprint 5: LoadBC+Contact+Constraint Audit ===')
