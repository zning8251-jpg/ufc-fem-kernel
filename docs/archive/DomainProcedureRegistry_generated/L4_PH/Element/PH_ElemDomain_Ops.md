...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L4_PH/Element/PH_ElemDomain_Ops.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
| SUBROUTINE | `PH_Elem_ComputeInternalForce` | 105 | `SUBROUTINE PH_Elem_ComputeInternalForce(args)` |
| SUBROUTINE | `PH_Element_Ctan6_RotateCt_LabToRThetaZ` | 129 | `SUBROUTINE PH_Element_Ctan6_RotateCt_LabToRThetaZ(R, C_lab, C_rtz)` |
| SUBROUTINE | `PH_Element_StressVoigt6_ToPlane3_124` | 138 | `SUBROUTINE PH_Element_StressVoigt6_ToPlane3_124(sigma6, sigma3)` |
| SUBROUTINE | `PH_Element_StressVoigt6_ToCax4_1325` | 146 | `SUBROUTINE PH_Element_StressVoigt6_ToCax4_1325(sigma6, sigma4)` |
| SUBROUTINE | `PH_Element_TM_AssembleKe_Coupled` | 155 | `SUBROUTINE PH_Element_TM_AssembleKe_Coupled(elem_type_id, coords, props, Ke, status)` |
