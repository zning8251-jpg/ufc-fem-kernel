...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L4_PH/Material/Elas/PH_Mat_Elas_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
```fortran
  ...
  CONTAINS
    ...
    PROCEDURE :: Copy   => PH_Mat_Elas_Desc_Copy
    PROCEDURE :: Clean  => PH_Mat_Elas_Desc_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init     => PH_Mat_Elas_State_Init
    PROCEDURE :: Update   => PH_Mat_Elas_State_Update
    PROCEDURE :: Clean    => PH_Mat_Elas_State_Clean
    PROCEDURE :: Reset    => PH_Mat_Elas_State_Reset
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => PH_Mat_Elas_Algo_Init
    PROCEDURE :: Config => PH_Mat_Elas_Algo_Config
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init      => PH_Mat_Elas_Ctx_Init
    PROCEDURE :: CacheStif => PH_Mat_Elas_Ctx_CacheStif
    PROCEDURE :: Clean     => PH_Mat_Elas_Ctx_Clean
...
|------|------|------|-------------------------|
| SUBROUTINE | `PH_Mat_Elas_Desc_Init` | 186 | `SUBROUTINE PH_Mat_Elas_Desc_Init(this, sub_type, nprops, props, status)` |
| SUBROUTINE | `PH_Mat_Elas_Desc_Valid` | 206 | `SUBROUTINE PH_Mat_Elas_Desc_Valid(this, status)` |
| SUBROUTINE | `PH_Mat_Elas_Desc_Copy` | 219 | `SUBROUTINE PH_Mat_Elas_Desc_Copy(this, other, status)` |
| SUBROUTINE | `PH_Mat_Elas_Desc_Clean` | 235 | `SUBROUTINE PH_Mat_Elas_Desc_Clean(this)` |
| SUBROUTINE | `PH_Mat_Elas_State_Init` | 245 | `SUBROUTINE PH_Mat_Elas_State_Init(this)` |
| SUBROUTINE | `PH_Mat_Elas_State_Update` | 253 | `SUBROUTINE PH_Mat_Elas_State_Update(this, stress, strain)` |
| SUBROUTINE | `PH_Mat_Elas_State_Clean` | 262 | `SUBROUTINE PH_Mat_Elas_State_Clean(this)` |
| SUBROUTINE | `PH_Mat_Elas_State_Reset` | 270 | `SUBROUTINE PH_Mat_Elas_State_Reset(this)` |
| SUBROUTINE | `PH_Mat_Elas_Algo_Init` | 280 | `SUBROUTINE PH_Mat_Elas_Algo_Init(this)` |
| SUBROUTINE | `PH_Mat_Elas_Algo_Config` | 287 | `SUBROUTINE PH_Mat_Elas_Algo_Config(this, tangent_type, use_num_tangent)` |
| SUBROUTINE | `PH_Mat_Elas_Ctx_Init` | 299 | `SUBROUTINE PH_Mat_Elas_Ctx_Init(this)` |
| SUBROUTINE | `PH_Mat_Elas_Ctx_CacheStif` | 307 | `SUBROUTINE PH_Mat_Elas_Ctx_CacheStif(this, D_el)` |
| SUBROUTINE | `PH_Mat_Elas_Ctx_Clean` | 314 | `SUBROUTINE PH_Mat_Elas_Ctx_Clean(this)` |
