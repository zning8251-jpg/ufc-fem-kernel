...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L4_PH/Material/Damage/PH_Mat_Damage_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
```fortran
  ...
  CONTAINS
    PROCEDURE, PASS :: Init  => PH_Mat_Damage_Desc_Init
    PROCEDURE, PASS :: Valid => PH_Mat_Damage_Desc_Valid
    PROCEDURE, PASS :: Clean => PH_Mat_Damage_Desc_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE, PASS :: Init   => PH_Mat_Damage_State_Init
    PROCEDURE, PASS :: Update => PH_Mat_Damage_State_Update
    PROCEDURE, PASS :: Clean  => PH_Mat_Damage_State_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE, PASS :: Init   => PH_Mat_Damage_Algo_Init
    PROCEDURE, PASS :: Config => PH_Mat_Damage_Algo_Config
...
```fortran
  ...
  CONTAINS
    PROCEDURE, PASS :: Init  => PH_Mat_Damage_Ctx_Init
    PROCEDURE, PASS :: Clean => PH_Mat_Damage_Ctx_Clean
...
|------|------|------|-------------------------|
| SUBROUTINE | `PH_Mat_Damage_Desc_Init` | 102 | `SUBROUTINE PH_Mat_Damage_Desc_Init(desc, sub_type, damage_law_type, nprops)` |
| FUNCTION | `PH_Mat_Damage_Desc_Valid` | 113 | `FUNCTION PH_Mat_Damage_Desc_Valid(desc) RESULT(valid)` |
| SUBROUTINE | `PH_Mat_Damage_Desc_Clean` | 119 | `SUBROUTINE PH_Mat_Damage_Desc_Clean(desc)` |
| SUBROUTINE | `PH_Mat_Damage_State_Init` | 129 | `SUBROUTINE PH_Mat_Damage_State_Init(state)` |
| SUBROUTINE | `PH_Mat_Damage_State_Update` | 140 | `SUBROUTINE PH_Mat_Damage_State_Update(state, stress, damage)` |
| SUBROUTINE | `PH_Mat_Damage_State_Clean` | 148 | `SUBROUTINE PH_Mat_Damage_State_Clean(state)` |
| SUBROUTINE | `PH_Mat_Damage_Algo_Init` | 161 | `SUBROUTINE PH_Mat_Damage_Algo_Init(algo)` |
| SUBROUTINE | `PH_Mat_Damage_Algo_Config` | 168 | `SUBROUTINE PH_Mat_Damage_Algo_Config(algo, threshold, softening, use_num_tang)` |
| SUBROUTINE | `PH_Mat_Damage_Ctx_Init` | 180 | `SUBROUTINE PH_Mat_Damage_Ctx_Init(ctx)` |
| SUBROUTINE | `PH_Mat_Damage_Ctx_Clean` | 187 | `SUBROUTINE PH_Mat_Damage_Ctx_Clean(ctx)` |
