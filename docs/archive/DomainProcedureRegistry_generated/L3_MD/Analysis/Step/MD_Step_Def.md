...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Analysis/Step/MD_Step_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*

## TYPE blocks

### `MD_Step_Inc_Evo_State` (lines 22–27)
...
### `MD_Step_Stp_Ctl_State` (lines 32–38)
...
### `MD_Step_Inc_Evo_Ctx` (lines 53–62)
...
### `MD_Step_Itr_Com_Ctx` (lines 67–72)
