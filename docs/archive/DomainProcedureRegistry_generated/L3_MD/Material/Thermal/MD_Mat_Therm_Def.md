...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Material/Thermal/MD_Mat_Therm_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => MD_Mat_Therm_State_Init
    PROCEDURE :: Update => MD_Mat_Therm_State_Update
    PROCEDURE :: Clean  => MD_Mat_Therm_State_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => MD_Mat_Therm_Algo_Init
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init  => MD_Mat_Therm_Ctx_Init
    PROCEDURE :: Clean => MD_Mat_Therm_Ctx_Clean
...
|------|------|------|-------------------------|
| SUBROUTINE | `MD_Mat_Therm_Desc_Init` | 161 | `SUBROUTINE MD_Mat_Therm_Desc_Init(this, sub_type, num_constants, dependencies, status)` |
| SUBROUTINE | `MD_Mat_Therm_Desc_Validate` | 202 | `SUBROUTINE MD_Mat_Therm_Desc_Validate(this, status)` |
| SUBROUTINE | `MD_Mat_Therm_Desc_ComputeDerived` | 230 | `SUBROUTINE MD_Mat_Therm_Desc_ComputeDerived(this, status)` |
| SUBROUTINE | `MD_Mat_Therm_Desc_Clean` | 246 | `SUBROUTINE MD_Mat_Therm_Desc_Clean(this)` |
| SUBROUTINE | `MD_Mat_Therm_State_Init` | 256 | `SUBROUTINE MD_Mat_Therm_State_Init(this)` |
| SUBROUTINE | `MD_Mat_Therm_State_Update` | 262 | `SUBROUTINE MD_Mat_Therm_State_Update(this, heat_flux, temperature)` |
| SUBROUTINE | `MD_Mat_Therm_State_Clean` | 270 | `SUBROUTINE MD_Mat_Therm_State_Clean(this)` |
| SUBROUTINE | `MD_Mat_Therm_Algo_Init` | 280 | `SUBROUTINE MD_Mat_Therm_Algo_Init(this)` |
| SUBROUTINE | `MD_Mat_Therm_Ctx_Init` | 291 | `SUBROUTINE MD_Mat_Therm_Ctx_Init(this)` |
| SUBROUTINE | `MD_Mat_Therm_Ctx_Clean` | 295 | `SUBROUTINE MD_Mat_Therm_Ctx_Clean(this)` |
