...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Material/Damage/MD_Mat_Damage_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => MD_Mat_Damage_State_Init
    PROCEDURE :: Update => MD_Mat_Damage_State_Update
    PROCEDURE :: Clean  => MD_Mat_Damage_State_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => MD_Mat_Damage_Algo_Init
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init  => MD_Mat_Damage_Ctx_Init
    PROCEDURE :: Clean => MD_Mat_Damage_Ctx_Clean
...
|------|------|------|-------------------------|
| SUBROUTINE | `MD_Mat_Damage_Desc_Init` | 168 | `SUBROUTINE MD_Mat_Damage_Desc_Init(this, sub_type, num_constants, dependencies, status)` |
| SUBROUTINE | `MD_Mat_Damage_Desc_Validate` | 210 | `SUBROUTINE MD_Mat_Damage_Desc_Validate(this, status)` |
| SUBROUTINE | `MD_Mat_Damage_Desc_ComputeDerived` | 258 | `SUBROUTINE MD_Mat_Damage_Desc_ComputeDerived(this, status)` |
| SUBROUTINE | `MD_Mat_Damage_Desc_Clean` | 282 | `SUBROUTINE MD_Mat_Damage_Desc_Clean(this)` |
| SUBROUTINE | `MD_Mat_Damage_State_Init` | 292 | `SUBROUTINE MD_Mat_Damage_State_Init(this)` |
| SUBROUTINE | `MD_Mat_Damage_State_Update` | 299 | `SUBROUTINE MD_Mat_Damage_State_Update(this, damage, energy, fully_damaged)` |
| SUBROUTINE | `MD_Mat_Damage_State_Clean` | 309 | `SUBROUTINE MD_Mat_Damage_State_Clean(this)` |
| SUBROUTINE | `MD_Mat_Damage_Algo_Init` | 320 | `SUBROUTINE MD_Mat_Damage_Algo_Init(this, softening_law)` |
| SUBROUTINE | `MD_Mat_Damage_Ctx_Init` | 339 | `SUBROUTINE MD_Mat_Damage_Ctx_Init(this)` |
| SUBROUTINE | `MD_Mat_Damage_Ctx_Clean` | 343 | `SUBROUTINE MD_Mat_Damage_Ctx_Clean(this)` |
