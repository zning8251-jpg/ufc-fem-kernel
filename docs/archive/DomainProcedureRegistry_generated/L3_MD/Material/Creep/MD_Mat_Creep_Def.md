...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Material/Creep/MD_Mat_Creep_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => MD_Mat_Creep_State_Init
    PROCEDURE :: Update => MD_Mat_Creep_State_Update
    PROCEDURE :: Clean  => MD_Mat_Creep_State_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => MD_Mat_Creep_Algo_Init
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init  => MD_Mat_Creep_Ctx_Init
    PROCEDURE :: Clean => MD_Mat_Creep_Ctx_Clean
...
|------|------|------|-------------------------|
| SUBROUTINE | `MD_Mat_Creep_Desc_Init` | 171 | `SUBROUTINE MD_Mat_Creep_Desc_Init(this, sub_type, num_constants, dependencies, status)` |
| SUBROUTINE | `MD_Mat_Creep_Desc_Validate` | 213 | `SUBROUTINE MD_Mat_Creep_Desc_Validate(this, status)` |
| SUBROUTINE | `MD_Mat_Creep_Desc_ComputeDerived` | 261 | `SUBROUTINE MD_Mat_Creep_Desc_ComputeDerived(this, status)` |
| SUBROUTINE | `MD_Mat_Creep_Desc_Clean` | 285 | `SUBROUTINE MD_Mat_Creep_Desc_Clean(this)` |
| SUBROUTINE | `MD_Mat_Creep_State_Init` | 295 | `SUBROUTINE MD_Mat_Creep_State_Init(this)` |
| SUBROUTINE | `MD_Mat_Creep_State_Update` | 302 | `SUBROUTINE MD_Mat_Creep_State_Update(this, creep_strain, equiv_creep_strain, creep_strain_rate)` |
| SUBROUTINE | `MD_Mat_Creep_State_Clean` | 312 | `SUBROUTINE MD_Mat_Creep_State_Clean(this)` |
| SUBROUTINE | `MD_Mat_Creep_Algo_Init` | 323 | `SUBROUTINE MD_Mat_Creep_Algo_Init(this)` |
| SUBROUTINE | `MD_Mat_Creep_Ctx_Init` | 334 | `SUBROUTINE MD_Mat_Creep_Ctx_Init(this)` |
| SUBROUTINE | `MD_Mat_Creep_Ctx_Clean` | 338 | `SUBROUTINE MD_Mat_Creep_Ctx_Clean(this)` |
