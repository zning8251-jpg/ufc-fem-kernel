...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L5_RT/Material/RT_Mat_Elas_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../05_Project_Planning/PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => RT_Mat_Elas_Desc_Init
    PROCEDURE :: Clean  => RT_Mat_Elas_Desc_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init   => RT_Mat_Elas_State_Init
    PROCEDURE :: Clean  => RT_Mat_Elas_State_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init => RT_Mat_Elas_Algo_Init
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init  => RT_Mat_Elas_Ctx_Init
    PROCEDURE :: Clean => RT_Mat_Elas_Ctx_Clean
...
```fortran
  ...
  CONTAINS
    PROCEDURE :: Init  => RT_Mat_Elas_Dispatch_Table_Init
    PROCEDURE :: Clean => RT_Mat_Elas_Dispatch_Table_Clean
...
|------|------|------|-------------------------|
| SUBROUTINE | `RT_Mat_Elas_Desc_Init` | 117 | `SUBROUTINE RT_Mat_Elas_Desc_Init(this, mat_id, sub_type, l4_slot)` |
| SUBROUTINE | `RT_Mat_Elas_Desc_Clean` | 128 | `SUBROUTINE RT_Mat_Elas_Desc_Clean(this)` |
| SUBROUTINE | `RT_Mat_Elas_State_Init` | 133 | `SUBROUTINE RT_Mat_Elas_State_Init(this, num_ips)` |
| SUBROUTINE | `RT_Mat_Elas_State_Clean` | 140 | `SUBROUTINE RT_Mat_Elas_State_Clean(this)` |
| SUBROUTINE | `RT_Mat_Elas_Algo_Init` | 146 | `SUBROUTINE RT_Mat_Elas_Algo_Init(this)` |
| SUBROUTINE | `RT_Mat_Elas_Ctx_Init` | 151 | `SUBROUTINE RT_Mat_Elas_Ctx_Init(this)` |
| SUBROUTINE | `RT_Mat_Elas_Ctx_Clean` | 158 | `SUBROUTINE RT_Mat_Elas_Ctx_Clean(this)` |
| SUBROUTINE | `RT_Mat_Elas_Dispatch_Table_Init` | 162 | `SUBROUTINE RT_Mat_Elas_Dispatch_Table_Init(this, max_entries, status)` |
| SUBROUTINE | `RT_Mat_Elas_Dispatch_Table_Clean` | 174 | `SUBROUTINE RT_Mat_Elas_Dispatch_Table_Clean(this)` |
