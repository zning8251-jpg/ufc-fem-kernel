...
- **Source**: `L4_PH/LoadBC/PH_Load_Def.f90`
- **Generated (UTC)**: 2026-05-14T07:52:52Z
- **MODULE (heuristic)**: `PH_Load_Def`
...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L4_PH/LoadBC/PH_Load_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*

## TYPE blocks

### `PH_Load_ElemEquivForce_Type` (lines 61–66)
...
### `PH_Load_SurfaceTraction_Type` (lines 69–74)
...
### `PH_Load_LoadIntegration_Type` (lines 77–81)
...
### `PH_Load_LoadCache_Type` (lines 84–91)
...
### `PH_Load_LoadCtrl_Type` (lines 94–118)
...
### `PH_Load_LoadRhs_Type` (lines 125–127)
...
### `PH_Load_LoadMassRhs_Type` (lines 130–133)
...
### `PH_Load_Init_Arg` (lines 136–139)
...
### `PH_Load_SetGravity_Arg` (lines 142–147)
...
### `PH_Load_ApplyLoads_Arg` (lines 150–154)
...
|------|------|------|-------------------------|
| SUBROUTINE | `PH_Load_Init` | 169 | `SUBROUTINE PH_Load_Init(arg)` |
| SUBROUTINE | `PH_Load_Free` | 194 | `SUBROUTINE PH_Load_Free(ctrl)` |
| SUBROUTINE | `PH_Load_SetGravity` | 233 | `SUBROUTINE PH_Load_SetGravity(arg)` |
| SUBROUTINE | `PH_Load_ApplyLoads` | 244 | `SUBROUTINE PH_Load_ApplyLoads(arg)` |
