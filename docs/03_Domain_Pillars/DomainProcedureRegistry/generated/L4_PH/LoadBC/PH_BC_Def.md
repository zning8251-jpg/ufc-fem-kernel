...
- **Source**: `L4_PH/LoadBC/PH_BC_Def.f90`
- **Generated (UTC)**: 2026-05-14T07:52:52Z
- **MODULE (heuristic)**: `PH_BC_Def`
...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L4_PH/LoadBC/PH_BC_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*

## TYPE blocks

### `PH_BC_Enforcement_Type` (lines 29–34)
...
### `PH_BC_InitPar_Type` (lines 63–65)
...
### `PH_BC_MethodPar_Type` (lines 68–71)
...
### `PH_BC_SystemAug_Type` (lines 80–83)
...
### `PH_BC_ApplyBCsIn_Type` (lines 86–89)
...
### `PH_BC_Dirichlet_Desc` (lines 92–96)
...
### `PH_BC_Neumann_Desc` (lines 99–103)
...
|------|------|------|-------------------------|
| SUBROUTINE | `PH_BC_Ctrl_Init_Scalar` | 125 | `SUBROUTINE PH_BC_Ctrl_Init_Scalar(ctrl, nTotalDOFs)` |
| SUBROUTINE | `PH_BC_Ctrl_Init_Par` | 140 | `SUBROUTINE PH_BC_Ctrl_Init_Par(ctrl, init_par)` |
| SUBROUTINE | `PH_BC_Ctrl_Free` | 149 | `SUBROUTINE PH_BC_Ctrl_Free(ctrl)` |
| SUBROUTINE | `PH_BC_Ctrl_SetMethod_Scalar` | 167 | `SUBROUTINE PH_BC_Ctrl_SetMethod_Scalar(ctrl, method, penalty_param)` |
| SUBROUTINE | `PH_BC_Ctrl_SetMethod_Par` | 175 | `SUBROUTINE PH_BC_Ctrl_SetMethod_Par(ctrl, method_par)` |
| SUBROUTINE | `PH_BC_Ctrl_ApplyBCs` | 184 | `SUBROUTINE PH_BC_Ctrl_ApplyBCs(ctrl, in_par)` |
...
| Lines | Header |
|-------|--------|
| 113–115 | `INTERFACE PH_BC_Ctrl_Init` |
| 116–118 | `INTERFACE PH_BC_Ctrl_SetMethod` |
