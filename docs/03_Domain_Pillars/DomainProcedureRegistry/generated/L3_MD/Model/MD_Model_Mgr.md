...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Model/MD_Model_Mgr.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
### `MD_Model_AdvProps` (lines 95–110)
...
| SUBROUTINE | `MD_Model_AdvProps_AddImport` | 609 | `SUBROUTINE MD_Model_AdvProps_AddImport(this, import_prop, status)` |
| SUBROUTINE | `MD_Model_AdvProps_AddPrestress` | 638 | `SUBROUTINE MD_Model_AdvProps_AddPrestress(this, prestress, status)` |
| SUBROUTINE | `MD_Model_AdvProps_AddSubstructure` | 667 | `SUBROUTINE MD_Model_AdvProps_AddSubstructure(this, substructure, status)` |
| SUBROUTINE | `MD_Model_AdvProps_Clear` | 696 | `SUBROUTINE MD_Model_AdvProps_Clear(this)` |
| FUNCTION | `MD_Model_AdvProps_FindImport` | 706 | `FUNCTION MD_Model_AdvProps_FindImport(this, name) RESULT(import_prop)` |
| FUNCTION | `MD_Model_AdvProps_FindPrestress` | 721 | `FUNCTION MD_Model_AdvProps_FindPrestress(this, name) RESULT(prestress)` |
| FUNCTION | `MD_Model_AdvProps_FindSubstructure` | 736 | `FUNCTION MD_Model_AdvProps_FindSubstructure(this, name) RESULT(substructure)` |
