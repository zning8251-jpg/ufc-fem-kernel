...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Material/User/MD_Mat_User_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
|------|------|------|-------------------------|
| SUBROUTINE | `Desc_Init` | 114 | `SUBROUTINE Desc_Init(this, sub_type, num_constants, dependencies, &` |
| SUBROUTINE | `Desc_Valid` | 158 | `SUBROUTINE Desc_Valid(this, status)` |
| SUBROUTINE | `Desc_ComputeDerived` | 176 | `SUBROUTINE Desc_ComputeDerived(this, status)` |
| SUBROUTINE | `Desc_Clean` | 184 | `SUBROUTINE Desc_Clean(this)` |
| SUBROUTINE | `State_Init` | 196 | `SUBROUTINE State_Init(this, n_state_vars)` |
| SUBROUTINE | `State_Update` | 207 | `SUBROUTINE State_Update(this, statev)` |
| SUBROUTINE | `State_Clean` | 217 | `SUBROUTINE State_Clean(this)` |
| SUBROUTINE | `Algo_Init` | 226 | `SUBROUTINE Algo_Init(this)` |
| SUBROUTINE | `Ctx_Init` | 235 | `SUBROUTINE Ctx_Init(this)` |
| SUBROUTINE | `Ctx_Clean` | 239 | `SUBROUTINE Ctx_Clean(this)` |
