...
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Material/Acoustic/MD_Mat_Acou_Def.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
...
|------|------|------|-------------------------|
| SUBROUTINE | `Desc_Init` | 115 | `SUBROUTINE Desc_Init(this, sub_type, num_constants, dependencies, status)` |
| SUBROUTINE | `Desc_Valid` | 152 | `SUBROUTINE Desc_Valid(this, status)` |
| SUBROUTINE | `Desc_ComputeDerived` | 170 | `SUBROUTINE Desc_ComputeDerived(this, status)` |
| SUBROUTINE | `Desc_Clean` | 181 | `SUBROUTINE Desc_Clean(this)` |
| SUBROUTINE | `State_Init` | 194 | `SUBROUTINE State_Init(this)` |
| SUBROUTINE | `State_Update` | 199 | `SUBROUTINE State_Update(this, pressure)` |
| SUBROUTINE | `State_Clean` | 205 | `SUBROUTINE State_Clean(this)` |
| SUBROUTINE | `Algo_Init` | 214 | `SUBROUTINE Algo_Init(this)` |
| SUBROUTINE | `Ctx_Init` | 223 | `SUBROUTINE Ctx_Init(this)` |
| SUBROUTINE | `Ctx_Clean` | 227 | `SUBROUTINE Ctx_Clean(this)` |
