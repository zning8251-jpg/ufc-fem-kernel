...
- **源码子路径（层下目录，不含文件名）**: `Element/Elem/Infinite`
- **Registry 布局（镜像 `ufc_core` 相对路径 + `.md`）**: `generated/L3_MD/Element/Elem/Infinite/MD_Elem_Infinite.md` — *与 [`UFC_ufc_core_目录权威分类.md`](../../../../../../PPLAN/06_核心架构/UFC_ufc_core_目录权威分类.md) 物理树一致；三段式/四段式解析见上*
