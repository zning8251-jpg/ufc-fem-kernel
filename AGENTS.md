...
ufc-layer-workflowUFC L3/L4/L5 域柱二元结构改造固化工作流：七步工序 S1–S7、域柱垂直切片、G1–G6 与 A+/物理三级验收、HANDOFF 交接、防偏离与 Harness 门禁。触发：域柱改造、贯通域柱、L3/L4/L5 同步改造、二元结构工作流、Populate 金线、波次改造。必读 UFC_L3L4L5_域柱改造固化工作流_v1.0.md + plan/workflows/L3L4L5_MASTER_PLAN.md。配合 ufc-governance-triad、ufc-layer-domain-feature、ufc-structured-io。project
...
| **L3/L4/L5 域柱改造工作流、七步工序、交接、防偏离**              | `ufc-layer-workflow`                      |
