!===============================================================================
! MODULE: AP_Cfg_Domain
! LAYER:  L6_AP
! DOMAIN: Config
! ROLE:   Domain �?configuration domain aggregate
! BRIEF:  Configuration parsing, AI switch, resource limits, governance.
!===============================================================================
