...
! LAYER:  L6_AP
! DOMAIN: Input/Parser
! ROLE:   Mgr ?input file parsing manager and command dispatch
! BRIEF:  Input file parsing and command dispatch for ABAQUS-format .inp files.
!
! Process phases:
!   P0: AP_Inp_Mgr_Init / AP_Inp_Mgr_Finalize
!   P1: AP_Inp_Mgr_Parse / AP_Inp_Mgr_MapKeywords
!   P3: AP_Inp_Mgr_Report
!===============================================================================
MODULE AP_Inp_Mgr
