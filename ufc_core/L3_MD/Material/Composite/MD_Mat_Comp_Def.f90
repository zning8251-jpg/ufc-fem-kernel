!===============================================================================
! MODULE: MD_Mat_Comp_Def
! LAYER:  L3_MD
! DOMAIN: Material / Composite
! ROLE:   Def
! BRIEF:  Unified TYPE definitions for composite material family.
...
MODULE MD_Mat_Comp_Def
  ...
  ! Owner: L3_MD layer
  !=======================================================================
  TYPE, PUBLIC, EXTENDS(MD_Mat_Desc) :: MD_Mat_Comp_Desc
    !--- Auxiliary nesting ---
    TYPE(MD_Mat_Comp_Cfg_Init_Desc) :: cfg
    TYPE(MD_Mat_Comp_Pop_Vld_Desc)  :: pop
...
CONTAINS
  ...
  !=============================================================================
  ! TBP IMPLEMENTATIONS: MD_Mat_Comp_Desc
  !=============================================================================

  SUBROUTINE Desc_Init(this, sub_type, num_constants, dependencies, status)
    CLASS(MD_Mat_Comp_Desc), INTENT(INOUT) :: this
    ...
    this%cfg%family_type    = MD_MAT_FAMILY_COMPOSITE
  ...
  SUBROUTINE Desc_Valid(this, status)
    CLASS(MD_Mat_Comp_Desc), INTENT(IN)  :: this
    TYPE(ErrorStatusType),   INTENT(OUT) :: status
    ...
    END IF
    IF (this%cfg%family_type /= MD_MAT_FAMILY_COMPOSITE) THEN
      status%status_code = -2; status%message = "Not COMPOSITE family"; RETURN
    END IF
    IF (this%cfg%sub_type < 801 .OR. this%cfg%sub_type > 805) THEN
  ...
  !=============================================================================
  ! TBP IMPLEMENTATIONS: MD_Mat_Comp_State
  !=============================================================================

  SUBROUTINE State_Init(this)
    CLASS(MD_Mat_Comp_State), INTENT(OUT) :: this
    this%fiber_damage_1  = 0.0_wp
    this%fiber_damage_2  = 0.0_wp
    this%matrix_damage_1 = 0.0_wp
    this%matrix_damage_2 = 0.0_wp
    this%shear_damage    = 0.0_wp
  END SUBROUTINE State_Init

  SUBROUTINE State_Update(this, fiber_d1, fiber_d2, matrix_d1, matrix_d2, shear_d)
    CLASS(MD_Mat_Comp_State), INTENT(INOUT) :: this
    REAL(wp),                 INTENT(IN)    :: fiber_d1, fiber_d2
    REAL(wp),                 INTENT(IN)    :: matrix_d1, matrix_d2
    REAL(wp),                 INTENT(IN)    :: shear_d

    this%fiber_damage_1  = fiber_d1
    this%fiber_damage_2  = fiber_d2
    this%matrix_damage_1 = matrix_d1
    this%matrix_damage_2 = matrix_d2
    this%shear_damage    = shear_d
  ...
  !=============================================================================
  ! TBP IMPLEMENTATIONS: MD_Mat_Comp_Algo
  !=============================================================================

  SUBROUTINE Algo_Init(this)
    CLASS(MD_Mat_Comp_Algo), INTENT(OUT) :: this
    this%integration_method = 1_i4
  END SUBROUTINE Algo_Init

  !=============================================================================
  ! TBP IMPLEMENTATIONS: MD_Mat_Comp_Ctx
  !=============================================================================

  SUBROUTINE Ctx_Init(this)
    CLASS(MD_Mat_Comp_Ctx), INTENT(OUT) :: this
  END SUBROUTINE Ctx_Init

  SUBROUTINE Ctx_Clean(this)
    CLASS(MD_Mat_Comp_Ctx), INTENT(INOUT) :: this
