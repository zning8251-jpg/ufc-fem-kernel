!===============================================================================
! MODULE: RT_Mat_Therm_Def
! LAYER:  L5_RT
! DOMAIN: Material / Therm
! ROLE:   Def
! BRIEF:  TYPE definitions for thermal material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Therm_Def
  ...
  ! TYPE :: RT_Mat_Therm_Dispatch_Arg
...
CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Therm_Desc), INTENT(OUT) :: this
