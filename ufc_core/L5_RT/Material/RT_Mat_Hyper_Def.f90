!===============================================================================
! MODULE: RT_Mat_Hyper_Def
! LAYER:  L5_RT
! DOMAIN: Material / Hyper
! ROLE:   Def
! BRIEF:  TYPE definitions for hyperelastic material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Hyper_Def
  ...
  ! TYPE :: RT_Mat_Hyper_Dispatch_Arg
  ...
  ABSTRACT INTERFACE
    SUBROUTINE rt_mat_hyper_eval_interface(l4_slot_index, ip_index, &
    ...
    END SUBROUTINE rt_mat_hyper_eval_interface
  END INTERFACE

  PUBLIC :: rt_mat_hyper_eval_interface

CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Hyper_Desc), INTENT(OUT) :: this
