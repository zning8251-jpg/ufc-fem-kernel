!===============================================================================
! MODULE: RT_Mat_Geo_Def
! LAYER:  L5_RT
! DOMAIN: Material / Geo
! ROLE:   Def
! BRIEF:  TYPE definitions for geomechanical material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Geo_Def
...
CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Geo_Desc), INTENT(OUT) :: this
