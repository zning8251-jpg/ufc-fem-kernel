!===============================================================================
! MODULE: RT_Mat_Visco_Def
! LAYER:  L5_RT
! DOMAIN: Material / Visco
! ROLE:   Def
! BRIEF:  TYPE definitions for viscoelastic material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Visco_Def
  ...
  ! TYPE :: RT_Mat_Visco_Dispatch_Arg
...
CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Visco_Desc), INTENT(OUT) :: this
