!===============================================================================
! MODULE: RT_Mat_Comp_Def
! LAYER:  L5_RT
! DOMAIN: Material / Comp
! ROLE:   Def
! BRIEF:  TYPE definitions for composite material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Comp_Def
...
CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Comp_Desc), INTENT(OUT) :: this
