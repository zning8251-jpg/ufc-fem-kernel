!===============================================================================
! MODULE: RT_Mat_User_Def
! LAYER:  L5_RT
! DOMAIN: Material / User
! ROLE:   Def
! BRIEF:  TYPE definitions for user material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_User_Def
  ...
  ABSTRACT INTERFACE
    SUBROUTINE rt_mat_user_eval_interface(l4_slot_index, ip_index, &
    ...
    END SUBROUTINE rt_mat_user_eval_interface
  END INTERFACE

  PUBLIC :: rt_mat_user_eval_interface

CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_User_Desc), INTENT(OUT) :: this
