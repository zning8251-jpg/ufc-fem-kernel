!===============================================================================
! MODULE: RT_Mat_Creep_Def
! LAYER:  L5_RT
! DOMAIN: Material / Creep
! ROLE:   Def
! BRIEF:  TYPE definitions for creep material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Creep_Def
  ...
  ! TYPE :: RT_Mat_Creep_Dispatch_Arg
...
CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Creep_Desc), INTENT(OUT) :: this
