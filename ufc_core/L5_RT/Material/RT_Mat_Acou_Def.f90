!===============================================================================
! MODULE: RT_Mat_Acou_Def
! LAYER:  L5_RT
! DOMAIN: Material / Acou
! ROLE:   Def
! BRIEF:  TYPE definitions for acoustic material routing at L5_RT layer.
!===============================================================================
MODULE RT_Mat_Acou_Def
...
CONTAINS
  SUBROUTINE Desc_Init(this, mat_id, l4_slot)
    CLASS(RT_Mat_Acou_Desc), INTENT(OUT) :: this
