!===============================================================================
! MODULE: RT_Asm_NLGeomEval
! LAYER:  L5_RT
! DOMAIN: Assembly
! ROLE:   Impl (nonlinear geometry eval, @DEPRECATED -> L4_PH)
! BRIEF:  Geometric nonlinearity evaluation -- K_G, internal force updates
!===============================================================================
!
!   Theory:
!   Deformation gradient: F = ∂x/∂X = I + ∇u
!   Green-Lagrange strain: E = 0.5*(F^T F - I)
!   Bathe FEM §6.3 (TL); Belytschko §4.3 (UL)
!   @DEPRECATED - All physics computation moved to L4_PH (PH_NLGeomEval_Algo)
!===============================================================================
...
!> Status: Production | Last verified: 2026-02-21
  ...
  ! INTF-001 Arg TYPE
  !=============================================================================
  PUBLIC :: RT_Asm_NLGeom_Eval_Args
