...
! ROLE:   Proc
! BRIEF:  CPS8 element definition (8-node plane stress Serendipity)
!===============================================================================
MODULE PH_Elem_CPS8
!> [CORE] CPS8 plane stress Serendipity quad (merged Defn+Sect+Constraints+Cont+Loads+Out)
  ...
  ! Constants
  INTEGER(i4), PARAMETER :: PH_ELEM_CPS8_NNODE  = 8_i4
  INTEGER(i4), PARAMETER :: PH_ELEM_CPS8_NIP   = 9_i4
  INTEGER(i4), PARAMETER :: PH_ELEM_CPS8_NDOF  = 16_i4
  INTEGER(i4), PARAMETER :: PH_ELEM_CPS8_NEDGE = 4_i4
  INTEGER(i4), PARAMETER :: PH_ELEM_CPS8_EDGE_NODES(2, 4) = RESHAPE([ 1,2, 2,3, 3,4, 4,1 ], [2, 4])
  INTEGER(i4), PARAMETER :: PH_ELEM_CPS8_FACE_NODES(2, 4) = RESHAPE([ 1,2, 2,3, 3,4, 4,1 ], [2, 4])
  ...
  ! PUBLIC
  !=============================================================================
  PUBLIC :: PH_Elem_CPS8_DefInit
  PUBLIC :: PH_Elem_CPS8_ShapeFunc_Arg
  PUBLIC :: PH_Elem_CPS8_ShapeFunc
  PUBLIC :: PH_Elem_CPS8_Jac_Arg
  PUBLIC :: PH_Elem_CPS8_Jac
  PUBLIC :: PH_Elem_CPS8_BMatrix_Arg
  PUBLIC :: PH_Elem_CPS8_BMatrix
  PUBLIC :: PH_Elem_CPS8_JacB_Arg
  PUBLIC :: PH_Elem_CPS8_JacB
  PUBLIC :: PH_Elem_CPS8_Strain_Arg
  PUBLIC :: PH_Elem_CPS8_Strain
  PUBLIC :: PH_Elem_CPS8_Stress_Arg
  PUBLIC :: PH_Elem_CPS8_Stress
  PUBLIC :: PH_Elem_CPS8_StiffMatrix_Arg
  PUBLIC :: PH_Elem_CPS8_FormStiffMatrix
  PUBLIC :: PH_Elem_CPS8_NL_TL_Arg
  PUBLIC :: PH_Elem_CPS8_NL_TL
  PUBLIC :: PH_Elem_CPS8_NL_UL_Arg
  PUBLIC :: PH_Elem_CPS8_NL_UL
  PUBLIC :: PH_Elem_CPS8_GaussPoints
  PUBLIC :: PH_Elem_CPS8_ConstMatrix
  PUBLIC :: PH_Elem_CPS8_FormIntForce
  PUBLIC :: PH_Elem_CPS8_FormIntForceFromStress
  PUBLIC :: PH_Elem_CPS8_StiffMatrix
  PUBLIC :: PH_Elem_CPS8_ConsMass
  PUBLIC :: PH_Elem_CPS8_LumpMass
  PUBLIC :: PH_Elem_CPS8_ThermStrainVector
  PUBLIC :: PH_Elem_CPS8_GetArea
  PUBLIC :: PH_Elem_CPS8_GetCentroid
  PUBLIC :: PH_Elem_CPS8_GetSectProps
  PUBLIC :: PH_Elem_CPS8_ApplyConstraint
  PUBLIC :: PH_Elem_CPS8_ApplyMPC
  PUBLIC :: PH_Elem_CPS8_FormContactContrib
  PUBLIC :: PH_Elem_CPS8_FormContactEdgeCtr
  PUBLIC :: PH_Elem_CPS8_FormNodalForce
  PUBLIC :: PH_Elem_CPS8_FormBodyForce
  PUBLIC :: PH_Elem_CPS8_FormEdgePressure
  PUBLIC :: PH_Elem_CPS8_CollectIPVars
  PUBLIC :: PH_Elem_CPS8_MapToNode
  PUBLIC :: PH_Elem_CPS8_GetExtrapMat
  PUBLIC :: PH_Elem_CPS8_EvalVonMises
  PUBLIC :: PH_Elem_CPS8_EvalPrincStress
  PUBLIC :: PH_Elem_CPS8_EvalStressInvar
  PUBLIC :: PH_Elem_CPS8_Material_Update_Routed
  PUBLIC :: PH_ELEM_CPS8_NNODE, PH_ELEM_CPS8_NIP, PH_ELEM_CPS8_NDOF, PH_ELEM_CPS8_NEDGE
  PUBLIC :: PH_ELEM_CPS8_EDGE_NODES, PH_ELEM_CPS8_FACE_NODES, PH_ELEM_GAUSS_PT

  ! Generic interfaces for legacy + structured + 3D (CPS8P)
  INTERFACE PH_Elem_CPS8_ShapeFunc
    MODULE PROCEDURE PH_Elem_CPS8_ShapeFunc_Legacy
    MODULE PROCEDURE PH_Elem_CPS8_ShapeFunc_InOut
    MODULE PROCEDURE PH_Elem_CPS8_ShapeFunc_3D
  END INTERFACE
  INTERFACE PH_Elem_CPS8_Jac
    MODULE PROCEDURE PH_Elem_CPS8_Jac_Legacy
    MODULE PROCEDURE PH_Elem_CPS8_Jac_InOut
    MODULE PROCEDURE PH_Elem_CPS8_Jac_3D
  END INTERFACE
  INTERFACE PH_Elem_CPS8_GaussPoints
    MODULE PROCEDURE PH_Elem_CPS8_GaussPoints_2D
    MODULE PROCEDURE PH_Elem_CPS8_GaussPoints_3D
  END INTERFACE
  INTERFACE PH_Elem_CPS8_JacB
    MODULE PROCEDURE PH_Elem_CPS8_JacB_Legacy
    MODULE PROCEDURE PH_Elem_CPS8_JacB_InOut
    MODULE PROCEDURE PH_Elem_CPS8_JacB_3D
  END INTERFACE
  INTERFACE PH_Elem_CPS8_BMatrix
    MODULE PROCEDURE PH_Elem_CPS8_BMatrix
    MODULE PROCEDURE PH_Elem_CPS8_BMatrix_3D
  END INTERFACE

  INTERFACE PH_Elem_CPS8_Strain
    MODULE PROCEDURE PH_Elem_CPS8_Strain_Legacy
    MODULE PROCEDURE PH_Elem_CPS8_Strain_InOut
  END INTERFACE

  INTERFACE PH_Elem_CPS8_Stress
    MODULE PROCEDURE PH_Elem_CPS8_Stress_Legacy
    MODULE PROCEDURE PH_Elem_CPS8_Stress_InOut
  END INTERFACE

  INTERFACE PH_Elem_CPS8_NL_TL
    MODULE PROCEDURE PH_Elem_CPS8_NL_TL_Structured
    MODULE PROCEDURE PH_Elem_CPS8_NL_TL_Legacy
  END INTERFACE

  INTERFACE PH_Elem_CPS8_NL_UL
    MODULE PROCEDURE PH_Elem_CPS8_NL_UL_Structured
    MODULE PROCEDURE PH_Elem_CPS8_NL_UL_Legacy
  END INTERFACE
...
CONTAINS
  ...
  !=============================================================================
  SUBROUTINE PH_Elem_CPS8_ShapeFunc_Legacy(xi, eta, N, dNdxi)
    REAL(wp), INTENT(IN)  :: xi, eta
    REAL(wp), INTENT(OUT) :: N(8)
    REAL(wp), INTENT(OUT) :: dNdxi(2, 8)
    TYPE(PH_Elem_CPS8_ShapeFunc_Arg) :: in
    TYPE(PH_Elem_CPS8_ShapeFunc_Arg) :: out
    in%xi = xi
    in%eta = eta
    CALL PH_Elem_CPS8_ShapeFunc_InOut(arg)
    N = out%N
    dNdxi = out%dNdxi
  END SUBROUTINE PH_Elem_CPS8_ShapeFunc_Legacy

  SUBROUTINE PH_Elem_CPS8_Jac_Legacy(dNdxi, coords, J, detJ)
    REAL(wp), INTENT(IN)  :: dNdxi(2, 8)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(OUT) :: J(2, 2)
    REAL(wp), INTENT(OUT) :: detJ
    TYPE(PH_Elem_CPS8_Jac_Arg) :: in
    TYPE(PH_Elem_CPS8_Jac_Arg) :: out
    in%dNdxi = dNdxi
    in%coords = coords
    CALL PH_Elem_CPS8_Jac_InOut(arg)
    J = out%J
    detJ = out%detJ
  END SUBROUTINE PH_Elem_CPS8_Jac_Legacy

  SUBROUTINE PH_Elem_CPS8_JacB_Legacy(coords, xi_pt, eta_pt, N, dNdx, J, detJ, B)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    ...
    TYPE(PH_Elem_CPS8_JacB_Arg) :: in
    TYPE(PH_Elem_CPS8_JacB_Arg) :: out
    in%coords = coords
    in%xi = xi_pt
    in%eta = eta_pt
    CALL PH_Elem_CPS8_JacB_InOut(arg)
    N = out%N
    dNdx = out%dNdx
    J = out%J
    detJ = out%detJ
    B = out%B
  END SUBROUTINE PH_Elem_CPS8_JacB_Legacy

  SUBROUTINE PH_Elem_CPS8_Strain_Legacy(B, u, strain)
    REAL(wp), INTENT(IN)  :: B(3, 16)
    REAL(wp), INTENT(IN)  :: u(16)
    REAL(wp), INTENT(OUT) :: strain(3)
    TYPE(PH_Elem_CPS8_Strain_Arg) :: in
    TYPE(PH_Elem_CPS8_Strain_Arg) :: out
    in%B = B
    in%u = u
    CALL PH_Elem_CPS8_Strain_InOut(arg)
    strain = out%strain
  END SUBROUTINE PH_Elem_CPS8_Strain_Legacy

  SUBROUTINE PH_Elem_CPS8_Stress_Legacy(epsilon, D, sigma)
    REAL(wp), INTENT(IN)  :: epsilon(3)
    REAL(wp), INTENT(IN)  :: D(3, 3)
    REAL(wp), INTENT(OUT) :: sigma(3)
    TYPE(PH_Elem_CPS8_Stress_Arg) :: in
    TYPE(PH_Elem_CPS8_Stress_Arg) :: out
    in%epsilon = epsilon
    in%D = D
    CALL PH_Elem_CPS8_Stress_InOut(arg)
    sigma = out%sigma
  END SUBROUTINE PH_Elem_CPS8_Stress_Legacy

  ! 3D overloads for CPS8P (coords(3,8), zeta ignored; use 2D plane x-y)
  SUBROUTINE PH_Elem_CPS8_ShapeFunc_3D(xi, eta, zeta, N, dNdxi)
    REAL(wp), INTENT(IN)  :: xi, eta, zeta
    REAL(wp), INTENT(OUT) :: N(8)
    REAL(wp), INTENT(OUT) :: dNdxi(3, 8)
    REAL(wp) :: dNdxi2(2, 8)
    CALL PH_Elem_CPS8_ShapeFunc_Legacy(xi, eta, N, dNdxi2)
    dNdxi(1:2, :) = dNdxi2
    dNdxi(3, :) = ZERO
  END SUBROUTINE PH_Elem_CPS8_ShapeFunc_3D

  SUBROUTINE PH_Elem_CPS8_Jac_3D(dNdxi, coords, J, detJ)
    ...
    J = ZERO
    J(3, 3) = ONE
    CALL PH_Elem_CPS8_Jac_Legacy(dNdxi(1:2, :), coords(1:2, :), J2, detJ)
    J(1:2, 1:2) = J2
  END SUBROUTINE PH_Elem_CPS8_Jac_3D

  SUBROUTINE PH_Elem_CPS8_JacB_3D(coords, xi_pt, eta_pt, zeta_pt, N, dNdx, J, detJ, B)
    REAL(wp), INTENT(IN)  :: coords(3, 8)
    ...
    REAL(wp), INTENT(OUT) :: detJ
    REAL(wp), INTENT(OUT) :: B(3, 16)
    REAL(wp) :: dNdx2(2, 8), J2(2, 2)
    CALL PH_Elem_CPS8_JacB_Legacy(coords(1:2, :), xi_pt, eta_pt, N, dNdx2, J2, detJ, B)
    dNdx(1:2, :) = dNdx2
    dNdx(3, :) = ZERO
    J = ZERO
    J(3, 3) = ONE
    J(1:2, 1:2) = J2
  END SUBROUTINE PH_Elem_CPS8_JacB_3D

  SUBROUTINE PH_Elem_CPS8_BMatrix_3D(dNdx, B)
    REAL(wp), INTENT(IN)  :: dNdx(3, 8)
    REAL(wp), INTENT(OUT) :: B(3, 16)
    TYPE(PH_Elem_CPS8_BMatrix_Arg) :: in
    TYPE(PH_Elem_CPS8_BMatrix_Arg) :: out
    in%dNdx = dNdx(1:2, :)
    CALL PH_Elem_CPS8_BMatrix(arg)
    B = out%B
  END SUBROUTINE PH_Elem_CPS8_BMatrix_3D

  !=============================================================================
  ! DEFINITION (core)
  !=============================================================================
  SUBROUTINE PH_ELEM_CPS8_AreaInt(coords, area)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    ...
    INTEGER(i4) :: ip
    area = ZERO
    CALL PH_Elem_CPS8_GaussPoints_2D(xi, eta, weights)
    DO ip = 1, 9
      CALL PH_Elem_CPS8_ShapeFunc_Legacy(xi(ip), eta(ip), N, dNdxi)
      CALL PH_Elem_CPS8_Jac_Legacy(dNdxi, coords, J, detJ)
      area = area + detJ * weights(ip)
    END DO
  END SUBROUTINE PH_ELEM_CPS8_AreaInt

  SUBROUTINE PH_Elem_CPS8_ThermStrainVector(alpha, deltaT, eps_th)
    ...
    eps_th(2) = e
    eps_th(3) = ZERO
  END SUBROUTINE PH_Elem_CPS8_ThermStrainVector

  SUBROUTINE PH_Elem_CPS8_BMatrix(arg)
    TYPE(PH_Elem_CPS8_BMatrix_Arg), INTENT(INOUT) :: arg
    INTEGER(i4) :: i
  ...
  END SUBROUTINE PH_Elem_CPS8_BMatrix

  SUBROUTINE PH_Elem_CPS8_ConsMass(coords, rho, Me)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    ...
    DO ip = 1, 9
      ...
      END DO
    END DO
  END SUBROUTINE PH_Elem_CPS8_ConsMass

  SUBROUTINE PH_Elem_CPS8_ConstMatrix(E_young, nu, D)
  ...
  END SUBROUTINE PH_Elem_CPS8_ConstMatrix

  SUBROUTINE PH_Elem_CPS8_DefInit()
  END SUBROUTINE PH_Elem_CPS8_DefInit

  SUBROUTINE PH_Elem_CPS8_FormIntForce(coords, u, E_young, nu, R_int)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(IN)  :: u(16)
    REAL(wp), INTENT(IN)  :: E_young, nu
    ...
    CALL PH_Elem_CPS8_GaussPoints_2D(xi, eta, weights)
    DO ip = 1, 9
      CALL PH_Elem_CPS8_JacB_Legacy(coords, xi(ip), eta(ip), N, dNdx, J, detJ, B)
      IF (ABS(detJ) <= 1.0e-12_wp) CYCLE
      CALL PH_Elem_CPS8_Strain_Legacy(B, u, strain)
      CALL PH_Elem_CPS8_Stress_Legacy(strain, D, sigma)
      R_int = R_int + MATMUL(TRANSPOSE(B), sigma) * detJ * weights(ip)
    END DO
  END SUBROUTINE PH_Elem_CPS8_FormIntForce

  SUBROUTINE PH_Elem_CPS8_FormIntForceFromStress(coords, sigma3, R_int)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    ...
    END DO
  END SUBROUTINE PH_Elem_CPS8_FormIntForceFromStress

  SUBROUTINE PH_Elem_CPS8_StiffMatrix(coords, E_young, nu, Ke)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(IN)  :: E_young, nu
    ...
    END DO
  END SUBROUTINE PH_Elem_CPS8_StiffMatrix

  SUBROUTINE PH_Elem_CPS8_FormStiffMatrix(arg)
    TYPE(PH_Elem_CPS8_StiffMatrix_Arg), INTENT(INOUT) :: arg
    REAL(wp) :: xi(9), eta(9), weights(9)
    TYPE(PH_Elem_CPS8_JacB_Arg) :: jb
    REAL(wp) :: BTD(16, 3), dV
    INTEGER(i4) :: ip
    CALL init_error_status(arg%status)
    arg%evo%Ke = ZERO
    ...
    DO ip = 1, 9
      jb%xi = xi(ip)
      jb%eta = eta(ip)
      CALL PH_Elem_CPS8_JacB_InOut(jb)
    ...
    END DO
    arg%status%status_code = IF_STATUS_OK
  END SUBROUTINE PH_Elem_CPS8_FormStiffMatrix

  SUBROUTINE PH_Elem_CPS8_GaussPoints_2D(xi, eta, weights)
    ...
    eta(9) = g
    weights(9) = wc * wc
  END SUBROUTINE PH_Elem_CPS8_GaussPoints_2D

  SUBROUTINE PH_Elem_CPS8_GaussPoints_3D(xi, eta, zeta, weights)
    REAL(wp), INTENT(OUT) :: xi(9), eta(9), zeta(9), weights(9)
    zeta = ZERO
    CALL PH_Elem_CPS8_GaussPoints_2D(xi, eta, weights)
  END SUBROUTINE PH_Elem_CPS8_GaussPoints_3D

  SUBROUTINE PH_Elem_CPS8_Jac_InOut(arg)
    TYPE(PH_Elem_CPS8_Jac_Arg), INTENT(INOUT) :: arg
    INTEGER(i4) :: i
    CALL init_error_status(arg%status)
    arg%J = ZERO
    DO i = 1, 8
    ...
    arg%status%status_code = IF_STATUS_OK
  END SUBROUTINE PH_Elem_CPS8_Jac_InOut

  SUBROUTINE PH_Elem_CPS8_JacB_InOut(arg)
    TYPE(PH_Elem_CPS8_JacB_Arg), INTENT(INOUT) :: arg
    TYPE(PH_Elem_CPS8_ShapeFunc_Arg) :: sf
    TYPE(PH_Elem_CPS8_Jac_Arg) :: jac
    TYPE(PH_Elem_CPS8_BMatrix_Arg) :: bm
    REAL(wp) :: dNdxi(2, 8), Jinv(2, 2)
    INTEGER(i4) :: i
    CALL init_error_status(arg%status)
    sf%xi = arg%xi
    sf%eta = arg%eta
    CALL PH_Elem_CPS8_ShapeFunc_InOut(sf)
    ...
    CALL PH_Elem_CPS8_Jac_InOut(jac)
    ...
    END IF
    arg%status%status_code = IF_STATUS_OK
  END SUBROUTINE PH_Elem_CPS8_JacB_InOut

  SUBROUTINE PH_Elem_CPS8_LumpMass(coords, rho, M_lumped)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(IN)  :: rho
    REAL(wp), INTENT(OUT) :: M_lumped(16)
    REAL(wp) :: area, m
    INTEGER(i4) :: i
    CALL PH_ELEM_CPS8_AreaInt(coords, area)
    m = rho * area / 8.0_wp
    DO i = 1, 8
      M_lumped(2*i-1) = m
      M_lumped(2*i)   = m
    END DO
  END SUBROUTINE PH_Elem_CPS8_LumpMass

  SUBROUTINE PH_Elem_CPS8_ShapeFunc_InOut(arg)
    TYPE(PH_Elem_CPS8_ShapeFunc_Arg), INTENT(INOUT) :: arg
    REAL(wp) :: xi, eta
    CALL init_error_status(arg%status)
    xi = arg%xi
    eta = arg%eta
    ...
    arg%status%status_code = IF_STATUS_OK
  END SUBROUTINE PH_Elem_CPS8_ShapeFunc_InOut

  SUBROUTINE PH_Elem_CPS8_Strain_InOut(arg)
    TYPE(PH_Elem_CPS8_Strain_Arg), INTENT(INOUT) :: arg
    INTEGER(i4) :: j
    CALL init_error_status(arg%status)
    arg%strain = ZERO
    DO j = 1, 16
    ...
    END DO
    arg%status%status_code = IF_STATUS_OK
  END SUBROUTINE PH_Elem_CPS8_Strain_InOut

  SUBROUTINE PH_Elem_CPS8_Stress_InOut(arg)
    TYPE(PH_Elem_CPS8_Stress_Arg), INTENT(INOUT) :: arg
    INTEGER(i4) :: j
    CALL init_error_status(arg%status)
    arg%sigma = ZERO
    DO j = 1, 3
    ...
    END DO
    arg%status%status_code = IF_STATUS_OK
  END SUBROUTINE PH_Elem_CPS8_Stress_InOut

  !=============================================================================
  ! NL_TL / NL_UL - Legacy (for RT_Asm) and Structured
  !=============================================================================
  SUBROUTINE PH_Elem_CPS8_NL_TL_Legacy(coords_ref, u_elem, D, Ke_mat, Ke_geo, R_int, status)
    ...
    END DO
    CALL PH_Elem_CPS8_GaussPoints_2D(xi_gp, eta_gp, wt_gp)
    ...
    DO igp = 1, 9
      CALL PH_Elem_CPS8_ShapeFunc_Legacy(xi_gp(igp), eta_gp(igp), N, dN_dxi)
      J_ref = ZERO
      DO i = 1, 8
  ...
  END SUBROUTINE PH_Elem_CPS8_NL_TL_Legacy

  SUBROUTINE PH_Elem_CPS8_NL_UL_Legacy(coords_prev, u_incr, D, Ke_mat, Ke_geo, R_int, status)
  ...
  END SUBROUTINE PH_Elem_CPS8_NL_UL_Legacy

  SUBROUTINE PH_Elem_CPS8_NL_TL_Structured(arg)
    TYPE(PH_Elem_CPS8_NL_TL_Arg), INTENT(INOUT) :: arg
    ...
    IF (ALLOCATED(arg%mat_prop%props) .AND. SIZE(arg%mat_prop%props) >= 2) THEN
      ...
      CALL PH_Elem_CPS8_ConstMatrix(E_young, nu, D)
    END IF
    CALL PH_Elem_CPS8_NL_TL_Legacy(arg%coords_ref, arg%lcl%u_elem, D, &
      arg%evo%Ke_mat, arg%evo%Ke_geo, arg%evo%R_int, arg%status)
    IF (ALLOCATED(arg%mat_state)) arg%mat_state = arg%mat_state
  END SUBROUTINE PH_Elem_CPS8_NL_TL_Structured

  SUBROUTINE PH_Elem_CPS8_NL_UL_Structured(arg)
    TYPE(PH_Elem_CPS8_NL_UL_Arg), INTENT(INOUT) :: arg
    REAL(wp) :: D(3, 3), E_young, nu
    D = ZERO
    D(1, 1) = ONE
    D(2, 2) = ONE
    ...
    IF (ALLOCATED(arg%mat_prop%props) .AND. SIZE(arg%mat_prop%props) >= 2) THEN
      ...
      CALL PH_Elem_CPS8_ConstMatrix(E_young, nu, D)
    END IF
    CALL PH_Elem_CPS8_NL_UL_Legacy(arg%coords_prev, arg%u_incr, D, &
      arg%evo%Ke_mat, arg%evo%Ke_geo, arg%evo%R_int, arg%status)
    IF (ALLOCATED(arg%mat_state)) arg%mat_state = arg%mat_state
  END SUBROUTINE PH_Elem_CPS8_NL_UL_Structured

  !=============================================================================
  ! SECTION (inlined)
  !=============================================================================
  SUBROUTINE PH_Elem_CPS8_GetArea(coords, area)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(OUT) :: area
    CALL PH_ELEM_CPS8_AreaInt(coords, area)
  END SUBROUTINE PH_Elem_CPS8_GetArea

  SUBROUTINE PH_Elem_CPS8_GetCentroid(coords, centroid)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    ...
    END IF
  END SUBROUTINE PH_Elem_CPS8_GetCentroid

  SUBROUTINE PH_Elem_CPS8_GetSectProps(coords, density_in, area, mass)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
  ...
  END SUBROUTINE PH_Elem_CPS8_GetSectProps

  !=============================================================================
  ! CONSTRAINTS (inlined)
  !=============================================================================
  SUBROUTINE PH_Elem_CPS8_ApplyConstraint(ctype, idof, val, penalty, K_el, F_el)
  ...
  END SUBROUTINE PH_Elem_CPS8_ApplyConstraint

  SUBROUTINE PH_Elem_CPS8_ApplyMPC(c, val, penalty, K_el, F_el)
    ...
    DO i = 1, 16
      ...
      END DO
    END DO
  END SUBROUTINE PH_Elem_CPS8_ApplyMPC

  !=============================================================================
  ! CONTACT (inlined)
  !=============================================================================
  SUBROUTINE PH_Elem_CPS8_FormContactContrib(edge_id, xi, eta, N, n, gap, penalty, edge_len, K_el, F_el)
    ...
    DO a = 1, 8
      ...
      END DO
    END DO
  END SUBROUTINE PH_Elem_CPS8_FormContactContrib

  SUBROUTINE PH_Elem_CPS8_FormContactEdgeCtr(edge_id, coords, gap, penalty, K_el, F_el)
    INTEGER(i4), INTENT(IN)  :: edge_id
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(IN)  :: gap
    REAL(wp), INTENT(IN)  :: penalty
    ...
    n1 = PH_ELEM_CPS8_EDGE_NODES(1, edge_id)
    n2 = PH_ELEM_CPS8_EDGE_NODES(2, edge_id)
    SELECT CASE (edge_id)
    CASE (1)
      xi = 0.0_wp
      eta = -ONE
    ...
    CASE (4)
      ...
      eta = 0.0_wp
    END SELECT
    CALL PH_Elem_CPS8_ShapeFunc_Legacy(xi, eta, N, dNdxi)
    ...
    n(1) = -t(2) / len
    n(2) =  t(1) / len
    CALL PH_Elem_CPS8_FormContactContrib(edge_id, xi, eta, N, n, gap, penalty, len, K_el, F_el)
  END SUBROUTINE PH_Elem_CPS8_FormContactEdgeCtr

  !=============================================================================
  ! LOADS (inlined)
  !=============================================================================
  SUBROUTINE PH_Elem_CPS8_FormEdgePressure(coords, p, edge_id, F_eq)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    REAL(wp), INTENT(IN)  :: p
    INTEGER(i4), INTENT(IN)  :: edge_id
    ...
    F_eq(ia)   = F_eq(ia)   + f3 * nx
    F_eq(ia+1) = F_eq(ia+1) + f3 * ny
  END SUBROUTINE PH_Elem_CPS8_FormEdgePressure

  SUBROUTINE PH_Elem_CPS8_FormBodyForce(coords, bx, by, F_eq)
    REAL(wp), INTENT(IN)  :: coords(2, 8)
    ...
    DO ip = 1, 9
      ...
      END DO
    END DO
  END SUBROUTINE PH_Elem_CPS8_FormBodyForce

  SUBROUTINE PH_Elem_CPS8_FormNodalForce(load_type, coords, val, edge_id, F_eq)
    ...
    IF (load_type == PH_ELEM_LOAD_BODY) THEN
      CALL PH_Elem_CPS8_FormBodyForce(coords, val(1), val(2), F_eq)
    ELSE IF (load_type == PH_ELEM_LOAD_EDGE_P .AND. SIZE(val) >= 1) THEN
      CALL PH_Elem_CPS8_FormEdgePressure(coords, val(1), edge_id, F_eq)
    END IF
  END SUBROUTINE PH_Elem_CPS8_FormNodalForce
  ...
  SUBROUTINE PH_Elem_CPS8_CollectIPVars(ip_stress, ip_strain, ip_peeq, n_ip, out_vars)
    ...
    DO ip = 1, MIN(n_ip, 9)
      ...
      END IF
    END DO
  END SUBROUTINE PH_Elem_CPS8_CollectIPVars

  SUBROUTINE PH_Elem_CPS8_EvalPrincStress(sigma, principal)
    ...
    principal(1) = p + q
    principal(2) = p - q
  END SUBROUTINE PH_Elem_CPS8_EvalPrincStress

  SUBROUTINE PH_Elem_CPS8_EvalStressInvar(sigma, I1, J2)
    REAL(wp), INTENT(IN)  :: sigma(3)
  ...
  END SUBROUTINE PH_Elem_CPS8_EvalStressInvar

  SUBROUTINE PH_Elem_CPS8_EvalVonMises(sigma, seq)
    REAL(wp), INTENT(IN)  :: sigma(3)
  ...
  END SUBROUTINE PH_Elem_CPS8_EvalVonMises

  SUBROUTINE PH_Elem_CPS8_GetExtrapMat(E)
    ...
    END IF
    E = MATMUL(Binv, A)
  END SUBROUTINE PH_Elem_CPS8_GetExtrapMat

  SUBROUTINE PH_Elem_CPS8_MapToNode(ip_vars, weights, node_vars)
    ...
    node_vars = ZERO
    CALL PH_Elem_CPS8_GetExtrapMat(E)
    ...
    DO ic = 1, n_comp
      ...
      END DO
    END DO
  END SUBROUTINE PH_Elem_CPS8_MapToNode

  SUBROUTINE PH_Elem_CPS8_Material_Update_Routed(rt_ctx, mat_slot, dStrain, &
    ...
    CALL PH_Elem_MatRoute_ElasticPlaneStress(rt_ctx, mat_slot, dStrain, &
                                             stress_old, stress_new, D_tangent, status)
  END SUBROUTINE PH_Elem_CPS8_Material_Update_Routed

END MODULE PH_Elem_CPS8
