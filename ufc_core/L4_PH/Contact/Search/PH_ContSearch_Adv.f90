!===============================================================================
! MODULE: PH_ContSearch_Adv
! LAYER:  L4_PH
! DOMAIN: Contact / Search
! ROLE:   Core
! BRIEF:  Advanced contact search (BVH/Octree/SpatialHash) — moved from L5_RT
!
! Theory: BVH O((N+M)*log(N+M)); Octree O(log N); Spatial Hash O(N)
!   Ericson (2005) Real-Time Collision Detection Ch.4
! LEGACY alias: RT_ContSearch (renamed to L4 naming)
! Status: ACTIVE | Last verified: 2026-04-28
!===============================================================================

MODULE PH_ContSearch_Adv
!> Status: PROGRESSIVE (partial implementation, see Arg TYPE compliance mode)
!> Theory: Ericson Real-Time Collision Detection ��4; ABAQUS Theory ��5.1 | Last verified: 2026-02-14
...
CONTAINS
  ...
  subroutine RT_Cont_InitSpatHashFromSea(coords, search_radius, &
  ...
  subroutine RT_Cont_ProjectPointToSeg_Impl(p, seg_a, seg_b, proj, t, dist_sq, status)
  ...
  subroutine RT_Cont_ProjectPointToTri_Impl(p, tri_a, tri_b, tri_c, proj, xi, eta, dist_sq, normal, status)
