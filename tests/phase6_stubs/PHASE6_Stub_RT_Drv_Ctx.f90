! Harness-only RT_Drv_Ctx_Mod (mirrors production for Phase6 smoke).
MODULE RT_Drv_Ctx_Mod
  ...
  PRIVATE
  PUBLIC :: RT_Drv_Ctx
  PUBLIC :: RT_Drv_Ctx_Init, RT_Drv_Ctx_Bind, RT_Drv_Ctx_SetModelDef, RT_Drv_Ctx_IsOK, RT_Drv_Ctx_GetStatus
...
CONTAINS
  ...
  SUBROUTINE RT_Drv_Ctx_Init(this)
    ...
    NULLIFY(this%model, this%solver, this%model_def, this%rt_status)
    this%job_name = ''
    this%success = .FALSE.
