!===============================================================================
! Module:  NM_TimeInt_Test
! Layer:   L2_NM
! Domain:  TimeInt
! Purpose: Minimal test framework for the TimeInt domain.
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE NM_TimeInt_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[NM_TimeInt_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE NM_TimeInt_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call NM_TimeInt_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call NM_TimeInt_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
