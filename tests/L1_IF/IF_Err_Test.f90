!===============================================================================
! Module:  IF_Error_Test
! Layer:   L1_IF
! Domain:  Error
! Purpose: Minimal test framework for the Error domain.
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE IF_Error_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[IF_Error_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE IF_Error_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call IF_Error_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call IF_Error_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
