!===============================================================================
! Module:  PH_Element_Test
! Layer:   L4_PH
! Domain:  Element
! Purpose: Minimal test framework for the Element domain.
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE PH_Element_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[PH_Element_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE PH_Element_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call PH_Elem_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call PH_Elem_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
