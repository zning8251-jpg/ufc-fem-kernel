...
MODULE PH_Constr_Test
  ...
  PUBLIC :: PH_Constraint_Run_Tests
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE PH_Constraint_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[PH_Constraint_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE PH_Constraint_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call PH_Constraint_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call PH_Constraint_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
