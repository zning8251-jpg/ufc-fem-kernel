...
! Layer:   L3_MD
! Domain:  Mesh
! Purpose: Minimal test framework for the Mesh domain.
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE MD_Mesh_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[MD_Mesh_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE MD_Mesh_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call MD_Mesh_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call MD_Mesh_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
