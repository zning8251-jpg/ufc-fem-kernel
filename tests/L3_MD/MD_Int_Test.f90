!===============================================================================
! Module:  MD_Interaction_Test
! Layer:   L3_MD
! Domain:  Interaction
! Purpose: Minimal test framework for the Interaction domain.
...
MODULE MD_Int_Test
  ...
  PUBLIC :: MD_Interaction_Run_Tests
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE MD_Interaction_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[MD_Interaction_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE MD_Interaction_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call MD_Interaction_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call MD_Interaction_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
