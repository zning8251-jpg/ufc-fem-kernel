!===============================================================================
! Module:  MD_Material_Test
! Layer:   L3_MD
! Domain:  Material
! Purpose: Minimal test framework for the Material domain.
...
CONTAINS
  ...
  !---------------------------------------------------------------------------
  SUBROUTINE MD_Material_Run_Tests(all_passed)
    ...
    WRITE(*,'(A,I4,A,I4,A)') "[MD_Material_Test] ", n_passed, " passed, ", &
                               n_failed, " failed"
  END SUBROUTINE MD_Material_Run_Tests
  ...
  SUBROUTINE test_init_finalize()
    ...
    ! TODO: Call MD_Material_Core Init with minimal valid inputs
    ! TODO: Verify status == IF_STATUS_OK
    ! TODO: Call MD_Material_Core Finalize
    ! TODO: Verify status == IF_STATUS_OK
